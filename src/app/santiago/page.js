...
export default function SantiagoPage() {
  const departamentos = [
    { nombre: "Aguirre", poblacion: "8 970", cabecera: "Pinto", localidades: "Argentina, Casares, Malbrán" },
    { nombre: "Alberdi", poblacion: "20 104", cabecera: "Campo Gallo", localidades: "Donadeu, Huachana, Sacháyoj, Santos Lugares" },
    { nombre: "Atamisqui", poblacion: "14 903", cabecera: "Villa Atamisqui", localidades: "Estación Atamisqui, Hoyón, Juanillo, Medellín" },
    { nombre: "Avellaneda", poblacion: "25 476", cabecera: "Herrera", localidades: "Colonia Dora, Icaño, Lugones, Punta Pozo, Real Sayana, Villa Mailín" },
    { nombre: "Banda", poblacion: "170 651", cabecera: "La Banda", localidades: "Clodomira, Abra Grande, Antajé, Ardiles, Cañada Escobar, Chaupi Pozo, El Aibe, Estación Simbolar, Los Quiroga, La Aurora, La Dársena, Negra Muerta" },
    { nombre: "Belgrano", poblacion: "10 813", cabecera: "Bandera", localidades: "Cuatro Bocas, Fortín Inca, Guardia Escolta" },
    { nombre: "Choya", poblacion: "43 736", cabecera: "Frías", localidades: "Choya, Laprida, Tapso, Villa La Punta" },
    { nombre: "Copo", poblacion: "35 741", cabecera: "Monte Quemado", localidades: "Pampa de los Guanacos, Ahí Veremos, El Caburé, Los Pirpintos, San José del Boquerón, Villa Matoque" },
    { nombre: "Figueroa", poblacion: "20 270", cabecera: "La Cañada", localidades: "Bandera Bajada, Caspi Corral - San Antonio, Colonia San Juan, La Cañada, La Invernada, Vaca Huañuna, Villa Figueroa" },
    { nombre: "General Taboada", poblacion: "46 508", cabecera: "Añatuya", localidades: "Los Juríes, Averías, Estación Tacañitas, La Simona, La Nena, Tomás Young" },
    ...
    { nombre: "Jiménez", poblacion: "18 625", cabecera: "Pozo Hondo", localidades: "El Arenal, El Bobadal, El Charco, Gramilla, Tres Cruces" },
    { nombre: "Juan Felipe Ibarra", poblacion: "20 589", cabecera: "Suncho Corral", localidades: "El Colorado, El Cuadrado, Matará, Melero, Pozo del Toba, San Antonio - Roldán, Vilelas, Yuchán" },
    { nombre: "Juan Francisco Borges", poblacion: "330 112", cabecera: "Santiago del Estero", localidades: "El Deán, Remes, San Benito, San Pedro, Santa María, Sol de Mayo, El Zanjón, Maco, Maquito, Mal Paso, Puestito San Antonio, Yanda, Vuelta de la Barranca" },
    { nombre: "Loreto", poblacion: "24 060", cabecera: "Loreto", localidades: "La Noria, San Vicente, Sauce Solo, Tío Pozo" },
    { nombre: "Mitre", poblacion: "1 440", cabecera: "Villa Unión", localidades: "Fuerte Esperanza, Abras, Unión, Captaros, Porongos" },
    { nombre: "Moreno", poblacion: "40 460", cabecera: "Quimilí", localidades: "Tintina, Amamá, Pampa Pozo, Santo Domingo, Granadero Gatica, Las Tinajas, Libertad, Lilo Viejo - Patay, Otumpa, Villa Brana, Weisburd" },
    { nombre: "Ojo de Agua", poblacion: "15 116", cabecera: "Villa Ojo de Agua", localidades: "Sol de Julio, El 49, Ambargasta" },
    { nombre: "Pellegrini", poblacion: "26 193", cabecera: "Nueva Esperanza", localidades: "Ahí Veremos, Campo Grande, El Mojón, Las Delicias, Pozo Betbeder, Quebracho Coto, Rapelli, Santo Domingo, Villa Mercedes" },
    { nombre: "Quebrachos", poblacion: "12 354", cabecera: "Sumampa", localidades: "Ramírez de Velazco" },
    { nombre: "Río Hondo", poblacion: "66 761", cabecera: "Termas de Río Hondo", localidades: "Acos - Pozo del Arbolito, Amicha, Colonia Tinco, El Sauzal, Lescano, Los Núñez, Los Ovejero, Pozuelos, Sotelo, Villa Río Hondo, Vinará" },
    { nombre: "Rivadavia", poblacion: "5 315", cabecera: "Selva", localidades: "Colonia Alpina, Palo Negro" },
    { nombre: "Robles", poblacion: "54 015", cabecera: "Fernández", localidades: "Beltrán, Ingeniero Forres, Colonia El Simbolar, Los Romanos - Santo Domingo, Vilmer, Villa Hipólita, Villa Robles" },
    { nombre: "Salavina", poblacion: "12 787", cabecera: "Los Telares", localidades: "Chilca Juliana, La Paliza, Sabagasta, Vaca Human, Villa Salavina" },
    { nombre: "San Martín", poblacion: "11 848", cabecera: "Brea Pozo", localidades: "Átoj Pozo, Estación Robles, Estación Taboada, Villa Nueva" },
    { nombre: "Sarmiento", poblacion: "5 038", cabecera: "Garza", localidades: "Matará, Sauce Bajada, Guaype" },
