                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        <div className="bg-gradient-to-br from-red-100 to-red-50 rounded-xl p-4 border-2 border-red-200 mb-2">
                          <div className="aspect-video bg-red-200/50 rounded-lg overflow-hidden">
                            <Image
                              src={caso.id === 3 ? '/antes1.5.jpg' : `/antes${caso.id}.jpg`}
                              alt={`Vivienda ${caso.familia} - Antes`}
                              width={800}
                              height={450}
                      ...
                      <div>
                        <div className="bg-gradient-to-br from-green-100 to-green-50 rounded-xl p-4 border-2 border-green-200 mb-2">
                          <div className="aspect-video bg-green-200/50 rounded-lg overflow-hidden">
                            <Image
                              src={caso.id <= 2 ? `/despues${caso.id}.jpg` : '/despues2.jpg'}
                              alt={`Vivienda ${caso.familia} - Después`}
                              width={800}
                              height={450}
                              className="w-full h-full object-cover"
                            />
